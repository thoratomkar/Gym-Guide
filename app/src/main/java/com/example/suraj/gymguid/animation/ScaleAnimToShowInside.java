...
/**
 * Created by suraj on 3/12/2018.
 */

public class ScaleAnimToShowInside extends ScaleAnimation
{
    ...
    public ScaleAnimToShowInside(float toX, float fromX, float toY, float fromY, int duration, View view,boolean vanishAfter)
    {
        super(fromX, toX, fromY, toY);
        MuscleGain.openLayout2 = view;
