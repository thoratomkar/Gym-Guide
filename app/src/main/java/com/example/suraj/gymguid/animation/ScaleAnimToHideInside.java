...
public class ScaleAnimToHideInside extends ScaleAnimation
{
    ...
    public ScaleAnimToHideInside(float fromX, float toX, float fromY, float toY, int duration, View view,boolean vanishAfter)
    {
        super(fromX, toX, fromY, toY);
        setDuration(duration);
        MuscleGain.openLayout2 = null;
        mView = view;
